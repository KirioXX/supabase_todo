...
abstract class $ToDoListCopyWith<$Res> {
  ...
  $Res call(
      {@JsonKey(name: 'todo_list_id') int id,
      @JsonKey(name: 'todo_list_title') String name});
}
...
class _$_ToDoList implements _ToDoList {
  const _$_ToDoList(
      {@JsonKey(name: 'todo_list_id') required this.id,
      @JsonKey(name: 'todo_list_title') required this.name});
...
abstract class _ToDoList implements ToDoList {
  const factory _ToDoList(
      {@JsonKey(name: 'todo_list_id') required int id,
      @JsonKey(name: 'todo_list_title') required String name}) = _$_ToDoList;
